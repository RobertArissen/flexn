...
var View = react_1.default.forwardRef(function (_a, refOuter) {
	var children = _a.children,
		style = _a.style,
		_b = _a.focus,
		focus = _b === void 0 ? true : _b,
		_c = _a.focusOptions,
		focusOptions = _c === void 0 ? {} : _c,
		parentContext = _a.parentContext,
		repeatContext = _a.repeatContext,
		_d = _a.onPress,
		onPress =
			_d === void 0
				? function () {
	...
	var scaleAnim = (0, react_1.useRef)(
	...
	var pctx =
		(repeatContext === null || repeatContext === void 0
			? void 0
			: repeatContext.parentContext) || parentContext;
	var animatorOptions =
		focusOptions.animatorOptions || exports.defaultAnimation;
	...
	var _g = (0, react_1.useState)(function () {
			if (!focus) {
				...
				return new view_1.default(
					tslib_1.__assign(
						tslib_1.__assign(
							{ focus: focus, repeatContext: repeatContext, parent: pctx },
							focusOptions
						),
						{ onFocus: onComponentFocus, onBlur: onComponentBlur }
					)
				);
			}
		}),
		ViewInstance = _g[0],
		setViewInstance = _g[1];
	...
	(0, react_1.useEffect)(
		function () {
			var _a;
			(_a =
				ViewInstance === null || ViewInstance === void 0
					? void 0
					: ViewInstance.updateEvents) === null || _a === void 0
				? void 0
				: _a.call(ViewInstance, {
						onPress: onPress,
	...
	(0, react_1.useEffect)(function () {
		...
		return function () {
			...
			if (focus) {
				...
				(_a = ViewInstance.getScreen()) === null || _a === void 0
					? void 0
					: _a.onViewRemoved(ViewInstance);
			}
		};
	}, []);
	var childrenWithProps = react_1.default.Children.map(
		children,
		function (child) {
	...
	var onLayout = function () {
		(0, layoutManager_1.measure)(ViewInstance, ref, undefined, function () {
			...
			(_a = ViewInstance.getScreen()) === null || _a === void 0
				? void 0
				: _a.removeComponentFromPendingLayoutMap(ViewInstance.getId());
		});
	};
	...
	if (focus) {
		return react_1.default.createElement(
			react_native_1.View,
			tslib_1.__assign({ style: flattenedStyle, onLayout: onLayout }, props, {
				ref: ref,
			}),
			childrenWithProps
		);
	...
	return react_1.default.createElement(
		react_native_1.View,
		tslib_1.__assign({ style: style }, props, { ref: ref }),
		childrenWithProps
	);
});
