...
var RecycleItemPool_1 = tslib_1.__importDefault(require("../utils/RecycleItemPool"));
...
var ViewabilityTracker_1 = tslib_1.__importDefault(require("./ViewabilityTracker"));
...
var VirtualRenderer = /** @class */ (function () {
    ...
    VirtualRenderer.prototype.handleDataSetChange = function (newDataProvider, shouldOptimizeForAnimations) {
        ...
        this._renderStack = tslib_1.__assign(tslib_1.__assign({}, this._renderStack), newRenderStack);
        for (var key in this._renderStack) {
            if (Object.prototype.hasOwnProperty.call(this._renderStack, key)) {
                var index = this._renderStack[key].dataIndex;
