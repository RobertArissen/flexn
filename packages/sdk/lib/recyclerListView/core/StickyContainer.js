...
var StickyHeader_1 = tslib_1.__importDefault(require("./sticky/StickyHeader"));
var StickyFooter_1 = tslib_1.__importDefault(require("./sticky/StickyFooter"));
...
var StickyContainer = /** @class */ (function (_super) {
    tslib_1.__extends(StickyContainer, _super);
    ...
    StickyContainer.prototype.renderCompat = function () {
        ...
        var recycler = React.cloneElement(this.props.children, tslib_1.__assign(tslib_1.__assign({}, this.props.children.props), { ref: this._getRecyclerRef, onVisibleIndicesChanged: this._onVisibleIndicesChanged, onScroll: this._onScroll, applyWindowCorrection: this._applyWindowCorrection, rowRenderer: this._rlvRowRenderer }));
