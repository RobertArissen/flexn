...
export default abstract class BaseScrollComponent extends React.Component<ScrollComponentProps, Record<string, unknown>> {
    abstract scrollTo(x: number, y: number, animate: boolean): void;
}
//# sourceMappingURL=BaseScrollComponent.d.ts.map