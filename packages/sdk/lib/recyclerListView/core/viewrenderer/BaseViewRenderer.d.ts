...
export interface ViewRendererProps<T> {
    ...
    height: number;
    width: number;
    childRenderer: (type: string | number, data: T, index: number, extendedState?: object, renderProps?: {
        style: object;
        ref: object;
...
export default abstract class BaseViewRenderer<T> extends ComponentCompat<ViewRendererProps<T>, Record<string, unknown>> {
...
//# sourceMappingURL=BaseViewRenderer.d.ts.map