...
var LayoutManager = /** @class */ (function () {
    ...
    LayoutManager.prototype.getStyleOverridesForIndex = function (_index) {
        return undefined;
    };
...
var WrapGridLayoutManager = /** @class */ (function (_super) {
    tslib_1.__extends(WrapGridLayoutManager, _super);
    function WrapGridLayoutManager(layoutProvider, renderWindowSize, isHorizontal, cachedLayouts, initialXOffset) {
        ...
        _this._initialXOffset = initialXOffset || 0;
        return _this;
    }
