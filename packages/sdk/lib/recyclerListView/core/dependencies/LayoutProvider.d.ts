...
export declare abstract class BaseLayoutProvider {
    ...
    abstract newLayoutManager(renderWindowSize: Dimension, isHorizontal?: boolean, cachedLayouts?: Layout[], initialXOffset?: number): LayoutManager;
...
export declare class LayoutProvider extends BaseLayoutProvider {
    ...
    newLayoutManager(renderWindowSize: Dimension, isHorizontal?: boolean, cachedLayouts?: Layout[], initialXOffset?: number): LayoutManager;
