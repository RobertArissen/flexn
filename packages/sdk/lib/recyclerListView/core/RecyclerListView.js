...
var ContextProvider_1 = tslib_1.__importDefault(require("./dependencies/ContextProvider"));
var DataProvider_1 = require("./dependencies/DataProvider");
var LayoutProvider_1 = require("./dependencies/LayoutProvider");
var CustomError_1 = tslib_1.__importDefault(require("./exceptions/CustomError"));
var RecyclerListViewExceptions_1 = tslib_1.__importDefault(require("./exceptions/RecyclerListViewExceptions"));
var Constants_1 = require("./constants/Constants");
var Messages_1 = require("./constants/Messages");
var VirtualRenderer_1 = tslib_1.__importDefault(require("./VirtualRenderer"));
var ItemAnimator_1 = require("./ItemAnimator");
var ComponentCompat_1 = require("../utils/ComponentCompat");
//#if [REACT-NATIVE]
var ScrollComponent_1 = tslib_1.__importDefault(require("../platform/reactnative/scrollcomponent/ScrollComponent"));
var ViewRenderer_1 = tslib_1.__importDefault(require("../platform/reactnative/viewrenderer/ViewRenderer"));
var react_native_1 = require("react-native");
var renative_1 = require("@rnv/renative");
var IS_WEB = !react_native_1.Platform || react_native_1.Platform.OS === 'web';
var IS_NATIVE_TV = renative_1.isPlatformTvos || renative_1.isPlatformAndroidtv || renative_1.isPlatformFiretv;
var RecyclerListView = /** @class */ (function (_super) {
    tslib_1.__extends(RecyclerListView, _super);
    function RecyclerListView(props, context) {
        var _this = _super.call(this, props, context) || this;
        _this.refreshRequestDebouncer = (0, lodash_debounce_1.default)(function (executable) {
            executable();
        });
    ...
    RecyclerListView.prototype.componentDidUpdate = function () {
        ...
        if (this.props.dataProvider.getSize() === 0) {
            console.warn(Messages_1.Messages.WARN_NO_DATA); // eslint-disable-line
        }
    };
    ...
    RecyclerListView.prototype.scrollToIndex = function (index, animate) {
        ...
        if (layoutManager) {
            ...
            console.warn(Messages_1.Messages.WARN_SCROLL_TO_INDEX); // eslint-disable-line
        }
    };
    /**
    ...
    RecyclerListView.prototype._checkAndChangeLayouts = function (newProps, forceFullRender) {
        ...
        if (this.props.layoutProvider !== newProps.layoutProvider ||
            ...
            this._virtualRenderer.setLayoutManager(newProps.layoutProvider.newLayoutManager(this._layout, newProps.isHorizontal, undefined, this.props.initialXOffset));
            ...
            if (layoutManager) {
                ...
                this._virtualRenderer.setLayoutManager(newProps.layoutProvider.newLayoutManager(this._layout, newProps.isHorizontal, cachedLayouts, this.props.initialXOffset));
                this._refreshViewability();
            }
        }
    ...
    RecyclerListView.prototype._initTrackers = function (props) {
        ...
        this._virtualRenderer.setParamsAndDimensions(this._params, this._layout);
        var layoutManager = props.layoutProvider.newLayoutManager(this._layout, props.isHorizontal, this._cachedLayouts, props.initialXOffset);
    ...
    RecyclerListView.prototype._getWindowCorrection = function (offsetX, offsetY, props) {
        return ((props.applyWindowCorrection && props.applyWindowCorrection(offsetX, offsetY, this._windowCorrection)) ||
