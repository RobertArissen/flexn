...
var StickyObject = /** @class */ (function (_super) {
    tslib_1.__extends(StickyObject, _super);
    ...
    StickyObject.prototype.renderCompat = function () {
        ...
        var content = (React.createElement(react_native_1.Animated.View, { style: [containerStyle, !this.props.renderContainer && { position: 'absolute' }] }, this.stickyVisiblity ? this._renderSticky() : null));
