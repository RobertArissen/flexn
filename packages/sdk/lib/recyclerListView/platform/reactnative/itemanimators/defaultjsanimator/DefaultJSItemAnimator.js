...
var DefaultJSItemAnimator = /** @class */ (function () {
    ...
    DefaultJSItemAnimator.prototype.animateWillMount = function (_atX, _atY, _itemIndex) {
        return undefined;
    };
    DefaultJSItemAnimator.prototype.animateDidMount = function (_atX, _atY, _itemRef, _itemIndex) {
        //no need
    };
    DefaultJSItemAnimator.prototype.animateWillUpdate = function (_fromX, _fromY, _toX, _toY, _itemRef, _itemIndex) {
        this._hasAnimatedOnce = true;
    };
    DefaultJSItemAnimator.prototype.animateShift = function (fromX, fromY, toX, toY, itemRef, _itemIndex) {
        var _this = this;
    ...
    DefaultJSItemAnimator.prototype.animateWillUnmount = function (_atX, _atY, itemRef, _itemIndex) {
