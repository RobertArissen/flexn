...
var BaseScrollView_1 = tslib_1.__importDefault(require("../../../core/scrollcomponent/BaseScrollView"));
...
var ScrollViewer = /** @class */ (function (_super) {
    ...
    ScrollViewer.prototype.render = function () {
        return !this.props.useWindowScroll ? (React.createElement("div", { ref: this._setDivRef, style: tslib_1.__assign({ WebkitOverflowScrolling: 'touch', height: '100%', overflowX: this.props.horizontal ? 'scroll' : 'hidden', overflowY: !this.props.horizontal ? 'scroll' : 'hidden', width: '100%' }, this.props.style) },
            React.createElement("div", { style: { position: 'relative' } }, this.props.children))) : (React.createElement("div", { ref: this._setDivRef, style: tslib_1.__assign({ position: 'relative' }, this.props.style) }, this.props.children));
    };
