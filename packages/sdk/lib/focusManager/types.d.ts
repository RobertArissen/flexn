...
export declare type PressableFocusOptions = {
...
export declare type ScreenFocusOptions = {
    forbiddenFocusDirections?: ForbiddenFocusDirections[];
    focusKey?: string;
...
export declare type RecyclableListFocusOptions = {
    forbiddenFocusDirections?: ForbiddenFocusDirections[];
    nextFocusLeft?: string | string[];
    nextFocusRight?: string | string[];
    nextFocusUp?: string | string[];
...
export declare type FocusMap = {
    [key: string]: AbstractModel;
};
export declare type View = ViewModel;
export declare type Recycler = RecyclerModel;
export declare type Screen = ScreenModel;
export declare type AbstractFocusModel = AbstractModel;
