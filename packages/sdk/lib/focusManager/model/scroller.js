...
var Scroller = /** @class */ (function () {
    ...
    Scroller.prototype.scroll = function (direction, contextParameters) {
        ...
        if (!(currentFocus === null || currentFocus === void 0 ? void 0 : currentFocus.getLayout())) {
        ...
        scrollContextParents.forEach(function (p) {
            var scrollTarget = p.isHorizontal()
                ? _this.calculateHorizontalScrollViewTarget(direction, p, contextParameters)
                : _this.calculateVerticalScrollViewTarget(direction, p, contextParameters);
            if (scrollTarget) {
    ...
    Scroller.prototype.scrollTo = function (cls, scrollTarget, direction) {
        ...
        if (constants_1.DIRECTION_VERTICAL.includes(direction) && parentSW.isNested()) {
            parentSW = (_a = cls.getParent()) === null || _a === void 0 ? void 0 : _a.getParent();
        }
        if (scrollTarget) {
    ...
    Scroller.prototype.getParentScrollers = function (currentFocus) {
        ...
        var parent = currentFocus === null || currentFocus === void 0 ? void 0 : currentFocus.getParent();
    ...
    Scroller.prototype.calculateHorizontalScrollViewTarget = function (direction, scrollView, contextParameters) {
        var _a, _b, _c, _d, _e;
        var currentFocus = contextParameters.currentFocus;
        var currentLayout = currentFocus.getLayout();
        var scrollTarget = { x: scrollView.getScrollOffsetX(), y: scrollView.getScrollOffsetY() };
        var horizontalViewportOffset = (_b = (_a = currentFocus.getScreen()) === null || _a === void 0 ? void 0 : _a.getHorizontalViewportOffset()) !== null && _b !== void 0 ? _b : constants_1.DEFAULT_VIEWPORT_OFFSET;
        var verticalViewportOffset = (_d = (_c = currentFocus.getScreen()) === null || _c === void 0 ? void 0 : _c.getVerticalViewportOffset()) !== null && _d !== void 0 ? _d : constants_1.DEFAULT_VIEWPORT_OFFSET;
        ...
        if (constants_1.DIRECTION_RIGHT.includes(direction)) {
            var xMaxScroll = scrollView.getLayout().xMaxScroll || ((_e = scrollView.getMostRightChildren().getLayout()) === null || _e === void 0 ? void 0 : _e.xMax) || 0;
            xMaxScroll += scrollView.getLayout().xMin || 0;
            //Prevent OVERSCROLL
            var targetX = currentLayout.xMin - scrollView.getLayout().xMin - horizontalViewportOffset + windowWidth;
        ...
        if (constants_1.DIRECTION_LEFT.includes(direction)) {
            scrollTarget.x = Math.min(currentLayout.xMin - scrollView.getLayout().xMin - horizontalViewportOffset, scrollView.getScrollOffsetX());
        }
        if (scrollTarget.x < 0)
            scrollTarget.x = 0;
        if (scrollTarget.y < 0)
    ...
    Scroller.prototype.calculateVerticalScrollViewTarget = function (direction, scrollView, contextParameters) {
        var _a, _b, _c;
        var currentFocus = contextParameters.currentFocus;
        var scrollContentHeight = scrollView.getLayout().scrollContentHeight;
        var currentLayout = currentFocus.getLayout();
        var scrollTarget = { x: scrollView.getScrollOffsetX(), y: scrollView.getScrollOffsetY() };
        var verticalViewportOffset = (_b = (_a = currentFocus.getScreen()) === null || _a === void 0 ? void 0 : _a.getVerticalViewportOffset()) !== null && _b !== void 0 ? _b : constants_1.DEFAULT_VIEWPORT_OFFSET;
        var yMaxScroll = scrollView.getLayout().yMaxScroll || ((_c = scrollView.getMostBottomChildren().getLayout()) === null || _c === void 0 ? void 0 : _c.yMax) || 0;
        yMaxScroll += scrollView.getLayout().yMin || 0;
        var targetY = currentLayout.yMin - scrollView.getLayout().yMin - verticalViewportOffset + scrollContentHeight;
        if (constants_1.DIRECTION_UP.includes(direction)) {
            var innerViewMin = scrollView.getLayout().innerView.yMin;
            scrollTarget.y = Math.min(currentLayout.yMin - innerViewMin - verticalViewportOffset - scrollView.getLayout().yMin, scrollView.getScrollOffsetY());
        }
        else {
